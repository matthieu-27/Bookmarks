...
class TagsiesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $folders = Folder::factory()->count(10)->create()->each(function (Folder $folder) use ($tags) {
        //     if (random_int(0, 1)) {
        ...
        // Bookmark::factory()->count(15)->create()->each(function (Bookmark $bookmark) use ($tags, $folders) {
        //     if (random_int(0, 1)) {
